...
class BooksDataSource:
    ...
    Python dictionary as None.
        ...
        {'id': 77, 'last-name': 'Murakami', 'first-name': 'Haruki',
    ...
    and 'publication-year'. For example, "Pride and Prejudice"
    (assuming an ID of 132) would look like this:

        {'id': 193, 'title': 'A Wild Sheep Chase', 'publication-year': 1982}
    ...
    def _load_books(self, filename):
        ...
        for row in file_reader:
            ...
            dictionary[book_id] = {"id": book_id, "title": title, 'publication-year': publication_year}
    ...
    def _load_authors(self, filename):
        ...
        for row in file_reader:
            ...
            dictionary[author_id] = {"id": author_id, 'last-name': last_name, 'first-name' : first_name, 'birth-year': birth_year, 'death-year': death_year}
    ...
    def books(self, *, author_id=None, search_text=None, start_year=None, end_year=None, sort_by='title'):
        ...
        if start_year != None:
            ...
            def filter_start_year(book):
                if book['publication-year'] >= start_year:
                    return True
                return False
        ...
        if end_year != None:
            ...
            def filter_end_year(book):
                if book['publication-year'] <= end_year:
                    return True
                return False
        ...
        if sort_by == "year":
            output_books_list.sort(key = itemgetter('publication-year', 'title'))
        else:
            output_books_list.sort(key = itemgetter('title', 'publication-year'))
    ...
    def authors(self, *, book_id=None, search_text=None, start_year=None, end_year=None, sort_by='birth-year'):
        ''' Returns a list of all the authors in this data source matching all of the
            ...
            The list of authors is sorted in an order depending on the sort_by parameter:
                ...
                'birth-year' - sorts by birth_year, breaking ties with (case-insenstive) last_name,
        ...
        if search_text != None:
            ...
            def filter_search_text(author):
                if search_text.lower() in (author['first-name'] + author['last-name']).lower():
                    return True
                return False
        ...
        if start_year != None:
            ...
            def filter_start_year(author):
                if author['death-year'] == None or author['death-year'] > start_year:
                    return True
                return False
        ...
        if sort_by == 'birth-year':
            output_authors_list.sort(key = itemgetter('birth-year', 'last-name', 'first-name'))
        else: #sort by title
            output_authors_list.sort(key = itemgetter('last-name', 'first-name', 'birth-year'))
